...
<div class="container">
	...
	<div class="hero">
		...
		<div class="row justify-content-around text-center">
			...
			<div class="tagline-container col-8">

				<h1 class="tagline-heading bold-title">Crafting Ingenuity</h1>
				<div class="tagline">
					<p class="bold-description">With commitment and a deep appreciation for the human element, we aim to craft superior experiences through ingenuity.</p>
		...
		<div class="row">
			...
			<div class="col-4">
				<div class="sandhills-goal">
					<img class="goal-icon" src="<?php echo SHD_IMAGES . 'icons/uplift-communities-icon.svg'; ?>">
			...
			<div class="col-4">
				<div class="sandhills-goal">
					<img class="goal-icon" src="<?php echo SHD_IMAGES . 'icons/empower-businesses-icon.svg'; ?>">
					<h3 class="goal-title title-border">Empowering businesses</h3>
					<p class="goal-description">We are the team of humans behind <a href="<?php echo $projects['edd']['url']; ?>">Easy Digital Downloads</a>, <a href="<?php echo $projects['rcp']['url']; ?>">Restrict Content Pro</a>, <a href="<?php echo $projects['awp']['url']; ?>">AffiliateWP</a>, <a href="<?php echo $projects['sc']['url']; ?>">Sugar Calendar</a>, <a href="<?php echo $projects['sb']['url']; ?>">SellBird</a>, <a href="<?php echo $projects['wpsp']['url']; ?>">WP Simple Pay</a>, and more.</p>
				</div>
			</div>
